...
if(isset($_POST['searchterm']))
    {
    	$searchQ = mysqli_real_escape_string($db, $_POST['searchterm']);
    	$searchQ = preg_replace("#[^0-9a-z]#i", "", $searchQ); 
    	
    	$query = mysqli_query($db,"SELECT * FROM Products WHERE Name LIKE '%$searchQ%' OR product_type LIKE '%$searchQ%' OR Product_number LIKE '%$searchQ%'")
